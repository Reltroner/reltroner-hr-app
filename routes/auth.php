...
Route::middleware('guest')->group(function () {
    ...
    Route::middleware('legacy.registration')->group(function () {
    ...
    Route::post('login', [AuthenticatedSessionController::class, 'store'])
        ->middleware('legacy.login');

    Route::middleware('legacy.login')->group(function () {
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('local.password')->group(function () {
